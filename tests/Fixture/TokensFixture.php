...
class TokensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '1-active, 2-used', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2018-06-06 22:35:28',
            'modified' => '2018-06-06 22:35:28'
        ],
    ];
}
