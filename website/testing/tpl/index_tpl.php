...
input validation not working on asp.net mvc 4 model sent as JSON</p> </a>
              <p class="descriptionquestion">this is how things work in my website a.com , users visits my website i talk to api
                  in another <a href="details.php" class="readmore">Read more</a></p> 
...
<footer class="container-fluid text-center">
  ...
  <p>Bootstrap Theme Made By <a href="" title="Visit phplearn">phplearn</a></p>
</footer>
