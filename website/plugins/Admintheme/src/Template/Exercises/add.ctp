            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <?= $this->Form->create($exercise, ['id' => 'addexercise', 'templates' => ['inputContainer' => '{{content}}']]) ?>

                        <div class="form-group form-float">
                            <div class="form-line">
                                <?= $this->Form->control('body_id', ['class' => 'form-control', 'type' => 'select','empty'=>__('Select Body'),'options' => $bodies]) ?> 
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
