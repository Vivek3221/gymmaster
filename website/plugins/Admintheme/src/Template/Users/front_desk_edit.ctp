                    ...
                    <div class="form-grid-2col">
                        <?php if (isset($users_type) && $users_type == 1) { ?>
                            <div class="form-field-group full-width-field">
                                <label><?= __('Partner') ?> <span class="req">*</span></label>
                        ...
                        <div class="form-field-group">
                            ...
                            <div class="gender-pill-group">
                                <input type="radio" name="gender" id="gender_male_edit" value="1" <?= (empty($user->gender) || $user->gender == 1) ? 'checked' : '' ?>>
                                <label for="gender_male_edit" class="gender-pill-btn">
                                    <i class="material-icons">male</i> <span><?= __('Male') ?></span>
                                </label>

                                <input type="radio" name="gender" id="gender_female_edit" value="2" <?= (!empty($user->gender) && $user->gender == 2) ? 'checked' : '' ?>>
                                <label for="gender_female_edit" class="gender-pill-btn">
                        ...
                        <div class="form-field-group full-width-field">
                            <label><?= __('Password') ?> <small style="color:#718096; font-weight:normal;">(Leave blank to keep existing password)</small></label>
                            <div class="password-input-wrapper">
                                ...
                                <button type="button" class="toggle-password-btn" onclick="togglePasswordVisibility('edit_pass_input', this)">
