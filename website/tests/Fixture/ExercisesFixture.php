...
class ExercisesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'body_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2017-12-23 16:36:42',
            'modified' => '2017-12-23 16:36:42'
        ],
    ];
}
