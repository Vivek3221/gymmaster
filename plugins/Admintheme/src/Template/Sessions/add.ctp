            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <?= $this->Form->create($session, ['id' => 'addbody', 'templates' => ['inputContainer' => '{{content}}']]) ?>
                            <?php if($user_type !=3)
                       {?>
                       ...
                       <?php }?>
                         ...
                         <div class="form-group form-float">
                            <div class="form-line">
                                <?= $this->Form->control('exrcisedirectorie_id', ['class' => 'form-control select', 'type' => 'select','empty'=>__('Select Excercise'),'options' => $get_exrcisedirectorie_lists]) ?> 
