                ...
                <div class="payment-body">
                    ...
                    <div class="field-grid">
                        <div class="form-field">
                            ...
                            <input type="text" value="<?= h($classEntry->trainer->name) ?>" readonly>
                        </div>

                        <div class="form-field">
                            <label><?= __('Month') ?></label>
                            <?php 
                            $monthName = date('F', mktime(0, 0, 0, $classEntry->month, 10));
                            ?>
                            <input type="text" value="<?= h($monthName) ?>" readonly>
                        </div>

                        <div class="form-field">
                            <label><?= __('Year') ?></label>
                            <input type="text" value="<?= h($classEntry->year) ?>" readonly>
                        </div>
                    ...
                    <div class="form-actions">
                        <?= $this->Form->button('<i class="material-icons" style="font-size:18px;vertical-align:middle;">check_circle</i> Save Changes', [
                            'class' => 'btn-save',
                            'escapeTitle' => false
                        ]) ?>
