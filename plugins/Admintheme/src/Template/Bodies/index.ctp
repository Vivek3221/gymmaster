                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id='status<?= $body->id ?>'>
                                            <?php
                                            if(isset($body->active)  && $body->active == '1'){
                                            ?>

  <?= $this->Form->button('Active',['class'=>'btn btn-success waves-effect','id'=>$body->id,'value'=>$body->active,'onclick'=>'updateStatus(this.id,'.$body->active.')' ]) ?>
                                            <?php
                                            } else {
                                                ?>
   <?= $this->Form->button('Inactive',['class'=>'btn btn-primary waves-effect','id'=>$body->id,'value'=>$body->active,'onclick'=>'updateStatus(this.id,'.$body->active.')' ]) ?>
                                                <?php
                                            }
                                            ?>
                                            </td>
