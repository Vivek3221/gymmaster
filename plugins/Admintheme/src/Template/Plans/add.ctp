<section class="content">
    <div class="container-fluid">
        ...
        <div class="plan-form-card">
            ...
            <div class="plan-row">
                ...
                <div class="plan-field-group">
                    ...
                    <?= $this->Form->control('title', [
                        ...
                        'class'       => '',
                        'label'       => false,
                        'placeholder' => 'e.g. Gold Monthly, Premium 3 Month',
                        'required'
                    ]) ?>
                </div>
            ...
            <!-- Days (auto-calculated, read-only display) -->
            <div class="plan-field-group">
                <label><?= __('Days (Auto-calculated)') ?></label>
                <div class="days-display-box" id="daysDisplay">
                    <i class="material-icons">today</i>
                    <span id="daysValue">Select a duration above</span>
                </div>
                <?= $this->Form->hidden('days', ['id' => 'planDaysInput', 'value' => 0]) ?>
            </div>
            ...
            <div class="plan-form-actions">
                <?= $this->Form->button('<i class="material-icons" style="font-size:18px;vertical-align:middle;">save</i> Save Plan', [
                    'class'         => 'btn-save-plan',
                    'escapeTitle'   => false
                ]) ?>
...
$(document).ready(function() {
    $('#plan-duration').on('change', function() {
        ...
        if (months >= 1 && months <= 12) {
            ...
            $('#daysDisplay').css({'border-color': '#4caf50', 'background': 'linear-gradient(135deg,#e8f5e9,#f1f8e9)'});
        } else {
            $('#daysValue').text('Select a duration above');
            $('#planDaysInput').val(0);
        }
    });
});
